          ...
          <div class="row album-list">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&bg=55595c&fg=eceeef&text=Thumbnail" alt="Card image cap" src = "<?= $post['post_image']?>" height =180px>
                <div class="card-body">
    ...
    <script type = 'text/javascript'>
        $(document).ready(function(){
          $('#load-more').on('click',function(event){
            ...
            var param = {}
            param.current =  $('.album-list').children('.col-md-4').length;
            param.type = 'product'
            param.limit = 3
            console.log(param);
